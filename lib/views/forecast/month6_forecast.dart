...
/// 暖候期/寒候期予報
class Month6Forecast extends StatelessWidget {
  final GfetchForecastData_month6 data;

  const Month6Forecast({super.key, required this.data});
              ...
              return Container(
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 110,
                      child: SeasonDate(dateLabel: formatMonth6Date(data.items[i].fromDate, data.items[i].toDate)),
                    ),
                    Container(
                      height: 40,
                      width: 1,
